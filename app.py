...
def submit_contact():
    try:
        ...
        # Plain text fallback
        text_body = f"""You have received a new project brief submission from the Shanti AI Showcase website.
...
<body style="font-family: 'Plus Jakarta Sans', 'Outfit', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #020208; margin: 0; padding: 0; -webkit-font-smoothing: antialiased;">
  <div class="email-container" style="max-width: 600px; margin: 40px auto; background-color: #0a0b10; border: 1px solid #1e1e2e; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5);">
    ...
    <div class="content" style="padding: 40px 30px; color: #f3f4f6;">
      <span class="badge" style="display: inline-block; background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); padding: 6px 14px; border-radius: 50px; color: #818cf8; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 24px;">New Inquiry</span>
      <h2 class="heading" style="font-family: 'Space Grotesk', -apple-system, sans-serif; font-size: 22px; font-weight: 700; margin: 0 0 16px 0; color: #ffffff;">Project Brief Submitted</h2>
      <p class="lead-text" style="font-size: 15px; color: #9ca3af; line-height: 1.6; margin: 0 0 30px 0;">A potential client has reached out to you through the Shanti AI Showcase website. Here are the submission details:</p>
    ...
    <div class="footer" style="background-color: #05060a; padding: 25px 30px; text-align: center; border-top: 1px solid #1e1e2e;">
      <p class="footer-text" style="font-size: 12px; color: #6b7280; line-height: 1.5; margin: 0;">
        This notification was auto-generated by the <a href="https://ai.shantiinfosoft.com" style="color: #9ca3af; text-decoration: none;">Shanti AI Showcase</a> platform.
      </p>
